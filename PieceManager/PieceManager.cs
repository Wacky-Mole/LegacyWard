    ...
    internal static void Patch_FejdStartup(FejdStartup __instance)
    {
        ...
        if (ConfigurationEnabled)
        {
            ...
            foreach (BuildPiece piece in registeredPieces)
            {
                ...
                {
                    StationExtension pieceExtensionComp = PieceManager.GoExtensions.GetOrAddComponent<StationExtension>(piece.Prefab);
...
public static class PiecePrefabManager
{
    ...
    private static GameObject CreateCategoryTab()
    {
        ...
        var component = PieceManager.GoExtensions.GetOrAddComponent<UIInputHandler>(newTab).m_onLeftDown += Hud.instance.OnLeftClickCategory;
